...
public class StreamsUnitTest {
    ...
    public void whenMapIdToEmployees_thenGetEmployeeStream() {
        ...
        assertEquals(employees.size(), empIds.length); //TODO: not a good test ... if one of ids doesn't exist one of employees are null and will be counting
    }
    ...
    public void whenFlatMapEmployeeNames_thenGetNameStream() {
        List<List<String>> namesNested = Arrays.asList(
          Arrays.asList("Jon", "Mary"),
          Arrays.asList("Jack", "Will"),
          Arrays.asList("Bill", "Max")
    ...
    public void whenFindMin_thenGetMinElementFromStream(){
        Employee firsEmp = empList.stream()
                .min((e1, e2) -> e1.getId() - e2.getId())
                .orElseThrow(NoSuchElementException::new);
        assertEquals(firsEmp.getId(), new Integer(1));
    }
    ...
    public void whenFindMax_thenGetMaxElementFromStream(){
        ...
        assertEquals(maxSalEmp.getSalary(), new Double(300000));
    }
    ...
    public void whenStreamReducing_thenGetValue(){
        ...
        Double salIncrOverhead = empList.stream().collect(
                Collectors.reducing(0.0, e -> e.getSalary() * percentage / 100, (e1, e2) -> e1 + e2));
    ...
    private List<String> getPalimdrome(Stream<String> stream, int length) {
    ...
    public void whenFileToStream_thenGetStream() throws IOException{
        ...
        List<String> str = getPalimdrome(Files.lines(Paths.get(fileName)), 5);
